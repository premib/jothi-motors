...
export default function ContactDetails() {
    return (<div className="contact-details">
        ...
        <p>
            <strong>Email:</strong>  <a href="mailto:viknesh006@gmail.com">viknesh006@gmail.com<LinkIcon /></a> <br /><br />
            <strong>Phone:</strong> <a href="tel:+919786301346">+91 97863 01346<LinkIcon /></a><br /><br />
        ...
        <IconButton className='whatsappButton' onClick={() => window.open('https://wa.me/9786301346', '_blank')}>
            <WhatsaPPIcon />
